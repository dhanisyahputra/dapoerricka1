...
if (!function_exists('format_rupiah')) {
    ...
    {
        // Pemeriksaan apakah $rp adalah bilangan sebelum memanggil number_format
        if (is_numeric($rp)) {
            return number_format($rp, 2, ',', '.');
        } else {
            // Jika $rp bukan bilangan, Anda bisa melakukan penanganan kesalahan atau mengembalikan nilai default
            return 'N/A';
        }
    }
}
