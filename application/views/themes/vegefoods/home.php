...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/coba2.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Dapur Ricka</h1>
            <h2 class="subheading mb-4">The Best Cake In Bogor</h2>
            <p><a href="#products" class="btn btn-danger">Buy Now</a></p>
          </div>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Best Seller Cake</h1>
            <h2 class="subheading mb-4">Nikmati kenikmatan dari toko sejati</h2>
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
      ...
      <h2 class="mb-4"><a href="#">Birthday Cake</a></h2>
      <p><a href="#">Kue dengan berbagai macam varian</a></p>
    </div>
  </div>   		
  </div>
  <div class="container">
